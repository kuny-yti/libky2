#ifndef ky_NUMBER_DOUBLE
#define ky_NUMBER_DOUBLE
                            ...
                            int *sign, char **rve, char **resultp, int *slen)
{
    ...
    *resultp = static_cast<char*>(kyMalloc(n + 1));
